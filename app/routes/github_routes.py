...
from app.services.github_service import list_branches
from app.schemas.pr_schema import PullRequestCreateRequest
...
@router.post("/pull-request/{owner}/{repo}")
def open_pull_request(owner: str, repo: str, request: PullRequestCreateRequest):
    try:
